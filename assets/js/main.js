...
var $author$project$Main$validateTime = function (val) {
	return A2($elm$regex$Regex$contains, $author$project$Main$timePattern, val) ? $author$project$Main$Valid : $author$project$Main$Invalid('Time is not in the correct format (e.g. hh:mm) ');
};
...
var $author$project$Main$viewContent = function (model) {
	return model.started ? $author$project$Main$viewCountdown(model) : $author$project$Main$viewForm(model);
};
